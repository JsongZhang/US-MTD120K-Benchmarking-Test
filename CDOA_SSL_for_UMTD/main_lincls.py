...
# feature show in Learnabel_head
...
def get_image_info(image_dir):
    ...
    image_info = Image.open(image_dir)  # 是一幅图片
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    elif args.arch.startswith('swin_t'):
    ...
    valdir = os.path.join("../UMTD/DATA_train_val/", 'val')
    normalize = transforms.Normalize(mean=[0.224, 0.224, 0.224],
                                     std=[0.418, 0.418, 0.418])
    # nature image dataset
    # train_dataset = datasets.CIFAR100('../NI/cifar100/CIFAR100/train/', train=True, transform=transforms.Compose([
    ...
    #     datasets.CIFAR100('../NI/cifar100/CIFAR100/train/', train=False, transform=transforms.Compose([
